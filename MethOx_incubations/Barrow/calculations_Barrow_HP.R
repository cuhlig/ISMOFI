...
# 0.1x; 6 bags #7, 10, 13, 16, 19, 22; day 2 seems to be bad
# 50x; 6 bags 8, 11, 14, 17, 20, 23; day 1 is odd, except for bag 8
# 1x; 4 bags 26, 29, 33, 37; 

#for processing of several samples add list of files here
filelist <- c(
   # list of files
  "Barrow.oxi.23.txt"
    )
...
for (file_name in file_names) {
  ...
  data.oxi <- merge(data.oxi, cali.HP.Barrow, by.x = "cali.date", by.y = "date", all.x = TRUE)
...
#calculate mean and sd of c.CH4.water  
